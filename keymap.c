...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL, KC_LALT,       KC_Z,     KC_X,        KC_C,     KC_V,          KC_B,     KC_N,    KC_M,      KC_COLN, KC_EQL,   KC_ESC,
                                      KC_LGUI,     KC_CAPS,  KC_RAISE,      KC_LOWER, KC_COMM, KC_DOT
    ),

    [_LOWER] = LAYOUT(
    KC_CALC, KC_LEFT,       KC_DOWN,  KC_UP,       KC_RIGHT, XXXXXXX,        KC_LT,   KC_7,    KC_8,      KC_9,    KC_CIRC,  KC_LPRN,
    KC_LSFT, KC_SCLN,       KC_UNDS,  KC_DQUO,     KC_SLSH,  KC_PERC,        KC_GT,   KC_4,    KC_5,      KC_6,    KC_PPLS,  KC_PAST,
    KC_LCTL, KC_LALT,       XXXXXXX,  XXXXXXX,     XXXXXXX,  XXXXXXX,        KC_0,    KC_1,    KC_2,      KC_3,    KC_MINS,  KC_SLSH,
                                      XXXXXXX,     XXXXXXX,  KC_RAISE,       KC_ENT,  XXXXXXX, KC_PDOT
    ),

    [_RAISE] = LAYOUT(
    XXXXXXX, KC_AT,         KC_DLR,   KC_PIPE,     KC_NUHS,  KC_TILD,       KC_DEL,   KC_LEFT, KC_DOWN,   KC_UP,   KC_RIGHT, KC_BSPC,
    KC_LSFT, XXXXXXX,       KC_QUES,  KC_GRV,      KC_BSLS,  KC_HASH,       XXXXXXX,  KC_HOME, KC_PGDN,   KC_PGUP, KC_END,   KC_RSFT,
